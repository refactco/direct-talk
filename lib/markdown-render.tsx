    ...
    return (
        <ReactMarkdown
            className={cn(
                ...
                "prose-h1:text-4xl prose-h1:font-semibold prose-h1:mt-8 prose-h1:mb-6",
            ...
            components={{
                ...
                tr({ node, children, ...props }) {
                    return (
                        <tr className="divide-x divide-slate-200 dark:divide-slate-700" {...props}>
                            {children}
                        </tr>
                    );
                },
                ...
                p({ node, className, children, ...props }) {
                    return (
                        <p
                            className="text-base leading-7 my-4"
                            {...props}
                        >
                            {children}
                        </p>
