...
interface ChatContextType {
  ...
  isLoading: boolean
  error: string | null
  doChat: (prompt: string, contentId: string, sessionId?: string) => Promise<any>
...
export const ChatProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const doChat = useCallback(async (prompt: string, contentIds: string, sessionId?: string): Promise<string> => {
    setIsLoading(true);
    setError(null);
