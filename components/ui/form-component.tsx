...
import { Mountain, Upload, X } from 'lucide-react';
        ...
        {selectedModelData &&
          (typeof selectedModelData.icon === 'string' ? (
            ...
            <selectedModelData.icon
              className={cn('w-3.5 h-3.5', selectedModelData.iconClass)}
            />
          ))}
                  ...
                  >
                    ...
                    >
                      {typeof model.icon === 'string' ? (
                        ...
                        <model.icon
                          className={cn('w-3 h-3', model.iconClass)}
                        />
                      )}
                    </div>
    ...
    >
      <AnimatePresence initial={false}>
        {searchGroups
          ...
          .map((group) => {
            const showItem =
              (isExpanded && !isProcessing) || props.selectedGroup === group.id;
            return (
              <motion.div
                key={group.id}
                layout={false}
