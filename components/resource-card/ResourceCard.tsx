...
export function ResourceCard({ resource, showDetails = true, hideType = false, isLoading = false }: HomeResourceCardProps) {
  ...
  return (
      <>
        ...
        <div className="w-full pt-2 pb-1">
          {
            !hideType ? <p className="text-[11px] font-semibold text-muted-foreground uppercase">
              {resource.type}
            </p> : null
          }
        ...
        <div
            className={cn(
                ...
                selected && "opacity-100", hideType && "bottom-1 right-0.5"
            )}
        >
          {selected ? (
              <div
