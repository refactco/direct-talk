  ...
  return (
    <form onSubmit={handleSubmit} className="relative">
      <div className="rounded-3xl border border-border bg-background overflow-hidden">
        {/* Selected Resources */}
        {
          selectedResources.length > 0 ? <div className="flex flex-wrap items-center gap-2 p-2 border-b border-border">
            {selectedResources.map((resource) => (
                ...
                >
                  ...
                  <div className="flex flex-col flex-grow min-w-0 pr-6">
                    <span className="text-[10px] leading-normal text-muted-foreground uppercase">{resource.type}</span>
        ...
        <div className="flex flex-col items-center p-3">
          ...
          <div className="flex items-center justify-between w-full">
            ...
            >
              <div
                  className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center bg-accent hover:bg-accent/80 transition-colors">
            ...
            >
              <ArrowRightIcon fill={isLoading || !input.trim() ? 'rgba(161, 161, 161, 1)' : '#052E16'}/>
            </button>
          </div>
        </div>
      </div>
